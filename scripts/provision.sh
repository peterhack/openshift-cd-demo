...
function usage() {
    ...
    echo "   --dynatrace               Dynatrace details dturl=abc12345.live.dynatrace.com apiToken=1234567890abcdefgh "
    echo
}
...
GITHUB_REF=${GITHUB_REF:-ocp-3.10-dtcli}
...
#adding Dynatrace Secret for DTCLI use
